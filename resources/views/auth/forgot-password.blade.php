<x-guest-layout>
    <div class="flex flex-col items-center justify-between px-6 py-2 mx-auto md:h-screen ">
        <div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4 text-center">Forgot Password</h3>
            ...
            <div class="flex items-center justify-between">
                <button type="submit" onclick="sendOTP()" class="btn-submit text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send OTP</button>
            </div>
        </div>
    </div>
</x-guest-layout>
