...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-between px-10 py-4">
        ...
        <div class="flex space-x-4 mt-1">
            ...
            <a href="{{ route('register') }}" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Register</a>
        </div>
    </div>
    <hr>
